	...
	protected class PublicationFieldBuilder implements LocaleChangeObserver {
		...
		private void addGeneralFields(Publication publication) {
			if (publication instanceof AbstractJournalBasedPublication journalPublication) {
				if (this.journal == null) {
					this.journal = new SingleJournalNameField(AbstractPublicationEditor.this.journalService, getAuthenticatedUser(),
				...
				if (this.conference == null) {
					this.conference = new SingleConferenceNameField(AbstractPublicationEditor.this.conferenceService, getAuthenticatedUser(),
